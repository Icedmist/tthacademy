...
import { Loader2, BookCheck, ClipboardCheck, XCircle, AlertTriangle, Eye } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Review student answers and approve completion for their courses.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
